...
function generateProject(destinationRoot, newProjectName, options) {
  ...
  if (yarnVersion) {
    ...
    execSync(`yarn add react-native-web@0.1.14 --save --save-exact`, {stdio: 'inherit'});
    execSync(`yarn add react-dom@16.1.1 --save --save-exact`, {stdio: 'inherit'});
  } else {
    console.log('Installing web...');
    execSync(`npm install ${webDeps} --dev --exact`, {stdio: 'inherit'});
    execSync(`yarn add react-native-web@0.1.14 --save --save-exact`, {stdio: 'inherit'});
    execSync(`npm install react-dom@16.1.1 --save --save-exact`, {stdio: 'inherit'});
  }
