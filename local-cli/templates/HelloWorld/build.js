...
'use strict';
require('./react-native-split/src/setupBabel');

const fs = require('fs');
const path = require('path');
const commander = require('commander');
const Util = require('./react-native-split/src/utils');
const Parser = require('./react-native-split/src/parser');
const bundle = require('./react-native-split/src/bundler');
