...
const MODULE_REGEX = /require\s?\(([0-9A-Za-z]+)[^)]*\)/g;
// const MODULE_REGEX_Dot = /require\s?\(([0-9]+\.[0-9]+)[^)]*\)/g;
...
// function getRegResult(bodyString){
//   const dotReg = MODULE_REGEX_Dot.exec(bodyString);
//   const normalReg = MODULE_REGEX.exec(bodyString);
//   if(dotReg !== null){
//     return dotReg
//   }else{
//     return normalReg
...
export function isExist(moduleName){
  return /\-common/.test(moduleName);
}
